...
verifySpotify = (req, res, next) => {
    /* 
        #swagger.security = [{
            "bearerSpotify": []
        }] 
        #swagger.responses[401] = { description: "Vous n'êtes pas authentifié(e) à Spotify." } 
        #swagger.responses[403] = { description: "Le token Spotify est invalide." } 
    */
    const authHeader = req.headers.authorization;
